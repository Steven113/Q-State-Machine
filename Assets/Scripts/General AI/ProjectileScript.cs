...
namespace Weapons
{
	public class ProjectileScript : MonoBehaviour
	{
		...
		//unit vector of direction that projectile is going
		public float speed;
		...
		public float airStabilisation = 0.25f;
		//a number between zero and 1, indicating how much the projectile is affected by gravity. Smaller z means the projectile falls more slowly
